### 01/02/2025 by Shoaib: These are the helper functions from Ashish Mahabal's repository. Some parts modified
...
# Scaling their bins to match the extrema of our data - Shoaib
...
def dmdtim(mjd, mag, ldmints, ldtints, normalise=True):
